...
output "nextcloud_bucket"     { value = var.nextcloud_bucket }
output "nextcloud_access_key" { value = var.nextcloud_access_key  sensitive = true }
output "nextcloud_secret_key" { value = var.nextcloud_secret_key  sensitive = true }
